    ...
    <header className="border-b hairline sticky top-0 z-30 bg-paper/95 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
        <Link href="/" className="flex flex-col">
          <span className="font-display text-2xl sm:text-3xl" style={{ color: "#0B6AE7" }}>
            COLLECT ALL VOLUMES
          </span>
          <span className="font-data text-[10px] uppercase tracking-widest text-stamp-red ml-3 mt-0.5">
            Manga Release Calendar
          </span>
        </Link>
